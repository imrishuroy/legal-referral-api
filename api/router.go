...
func (server *Server) setupRouter() {
	...
	auth.POST("/api/experience", server.addExperience)
	auth.POST("/api/education", server.addEducation)
	auth.POST("/api/review", server.addReview)
	auth.POST("/api/social", server.addSocial)
}
